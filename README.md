...
Disini proses yang kai lakukan sangat mirip dengan 1B, namun bedanya kami menggunakan 2 komparasi untuk kotanya, dan kami menggunakan `head -n 10` karena kami ingin mengambil 10 produk dengan profit terkecil.
